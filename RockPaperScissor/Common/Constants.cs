namespace RockPaperScissor.Common
{
    public static class Constants
    {
        ...
        public const string TieGame = "Tie Game";
        public const string InvalidInput = "Invalid input. Please input a number.";
        public const string InvalidAction = "Invalid action {0}. Please input 'Rock', 'Paper' or 'Scissors'.";
        public const string ExceptionMsg = "Unhandled action pair occured: {0}, {1}";
    }
}
